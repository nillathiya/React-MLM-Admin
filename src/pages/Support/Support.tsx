...
const Support: React.FC = () => {
  ...
  const fetchMessages = async (ticket: Tickets) => {
    ...
    try {
      ...
      await dispatch(fetchMessagesAsync({ ticketId, formData }));
    } catch (error: any) {
                                ...
                                <div className="rounded-lg shadow-md bg-white dark:bg-gray-900 p-4">
                                  ...
                                  <div className="mt-3 flex items-center">
                                    <input
                                      ...
                                      className="flex-1 border px-2 py-2 rounded-l-lg shadow-sm focus:ring focus:ring-green-300 bg-white dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600"
                                      placeholder="Type a message..."
                                    />
                                    <button
                                      onClick={sendMessage}
                                      className="w-20 min-w-[80px] max-w-[120px] bg-green-500 px-5 py-2 rounded-r-lg text-white shadow-md hover:bg-green-600 dark:hover:bg-green-400 transition"
                                    >
                                      Send
                                    </button>
                                  </div>
